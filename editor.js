// make sure we're on the admin side
if (!$("link[href='//libapps.s3.amazonaws.com/sites/615/include/local.css']").length) {
// Add necessary CSS that will not automatically be applied by SpringShare
$('head').append('<link rel="stylesheet" type="text/css" href="https://libapps.s3.amazonaws.com/sites/615/include/editor.css">');
